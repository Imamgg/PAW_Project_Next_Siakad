        ...
        <main class="ml-20 mr-20 mt-5">
            <div class="m-3 flex flex-col md:flex-row md:items-center md:justify-between space-y-4 md:space-y-0 ">
                <div class="bg-white p-4 rounded-xl shadow-md w-full">
                    <h2 class="text-3xl font-extrabold text-gray-900">Daftar Perpustakaan</h2>
                    <p class="mt-2 text-lg text-gray-600">Perpustakaan yang tersedia</p>
                </div>
            </div>
                    ...
                    <div class="bg-white rounded-xl shadow-sm overflow-hidden">
                        <div class="aspect-w-16 aspect-h-9">
                            <img src="http://localhost:3000/uploads/perpustakaan/{{ $library['cover'] }}"
                                alt="{{ $library['title'] }}" class="w-full object-cover">
                        </div>
                        <div class="p-6">
                            <div class="flex items-center text-sm text-gray-500 mb-4">
                                ...
                                author : {{ $library['author'] }}, Halaman : {{ $library['page'] }}
                            </div>
